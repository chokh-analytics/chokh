...
export const messages = {
  ...
  reports: {
    ...
    downloadCsv: 'CSV',
    downloadJson: 'JSON',
    downloadCsvName: 'Download CSV',
    downloadJsonName: 'Download JSON',
    downloadGroup: 'Download {title}',
    downloadNote: 'This card, this range, these filters, as the server writes it.',
    downloadJsonNote: 'What this card holds, as the API answered it.',
    referrers: 'Referrers',
    campaigns: 'Campaigns',
    tabSource: 'Source',
    tabMedium: 'Medium',
